...
## Download URL guidance

For v3.0.7-beta and later, `update_manifest.json` should include a direct release asset URL such as:

```text
https://github.com/ProtocolGoose/BravoFiresFDC-Public/releases/download/v3.0.7-beta/bravo_fires_fdc_v3_0_7_beta.zip
```

The app can also fall back to resolving GitHub release assets from the release tag page, but direct asset URLs are preferred for cleaner update downloads.
