...
The source code for Bravo Fires FDC is not stored in this repository. This repository is intended to host only public-facing release material such as:
...
The desktop application checks the public update manifest from this repository:
...
The public manifest is prepared for the v3.0.x update-checking foundation. Release assets should be attached through GitHub Releases.
